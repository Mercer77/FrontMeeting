                ...
                public void run() {
                    switch (mIndex) {
                        ...
                        case 1:
                            ...
                            mTcpv.setProgressByAnimation(800, 780);
                            break;
                        case 2:
                            mTcpv.setProgressByAnimation(780, 1000);
                            mTcpv.setText("识别成功");
                            Toast.makeText(DetectFaceActivity.this,"签到成功",Toast.LENGTH_LONG).show();
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Intent intent = new Intent(DetectFaceActivity.this,MainActivity.class);
                                    setResult(1);
                                    finish();
                                }
                            },2000);
